                    ...
                    <div className="items-center">
                        ...
                        <div className='flex justify-center mt-3'>
                            <button type="button" onClick={openEditModal}
                                    className="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-7 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900">Edit
                            </button>
